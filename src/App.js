...
// 地圖自動移動
function ChangeView({center}){ const map=useMap(); if(center) map.setView(center,16); return null; }
...
export default function App(){
  ...
  if(page==="home") return (
    <div className="home-screen">
      ...
      <div>
        <button onClick={()=>window.open("https://forms.gle/u9uHmAygxK5fRkmc7","_blank")}>回饋意見</button>
