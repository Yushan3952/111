...
const firebaseConfig = {
  apiKey: "AIzaSyAeX-tc-Rlr08KU8QcXDFdAx3LYHI",
...
export default function App() {
  const [screen, setScreen] = useState("start"); // start or map
  ...
  if (screen === "start") {
    return (
      <div className="container" style={{ textAlign: "center", background: "rgba(255,255,255,0.85)" }}>
        <h1>全民科學垃圾回報 APP</h1>
        <button onClick={() => setScreen("map")}>開始</button>
          ...
          >
            ...
            {manualLocation && (
              <Marker
                ...
                icon={getMarkerIcon(levelColors[trashLevel])}
              >
